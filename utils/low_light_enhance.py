...
if __name__ == "__main__":
    ...
    # 测试用例
    test_image_path = r"D:\mxy\FusionINV-main\data\LLVIP\vi\1.jpg"  # 替换为你的测试图像
    ...
    try:
        ...
        plt.tight_layout()
        output_path = "D:/mxy/FusionINV-main/outputs/test_enhancement.png"
        os.makedirs(os.path.dirname(output_path), exist_ok=True)  # 关键：自动创建 outputs 目录
        plt.savefig(output_path, dpi=150, bbox_inches='tight')
        print(f"✅ 测试完成，结果保存到 {output_path}")
